...
const user = props => __jsx("div", {
  ...
  id: "2432950841"
}, ["div.jsx-2432950841{border:1px solid #eee;box-shadow:0 2p 3px #ccc;padding:20px;text-align:center;}"]));
...
const authPage = props => auth_jsx("div", null, auth_jsx("h1", null, "The Auth Page - ", props.appName), auth_jsx(User, {
  age: 69,
  name: "Blake"
}));
